...
- **事件通知推送**（可选）：HTTP(S) POST + Bearer 鉴权，**系统事件**（宕机 / 强制关机 / 看门狗停止）与**网页电源操作**（开机 · 软关机 · 重启 · 强制关机 · 设备重启）均可推送；「服务器电源控制」卡片含「网页操作发送通知」开关控制后者
...
- **服务器电源控制**：开机 / 软关机 / 重启 / 强制关机 / 重置网络；卡片内含「网页操作发送通知」开关（开启后网页电源操作也会推送通知）
